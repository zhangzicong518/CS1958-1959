...
bool insertTest()
{
    ...
    for (int i = 0; i < 100; i++)
    {
        ...
        // std::cerr << deq.lastblock->elements.size << std::endl;
    }
    ...
    // {
    //     std::cerr << i << ": " << ans2[i] << " " << deq2[i] << std::endl;
    // }
    // std::cerr << deq2.front() << " " << deq2.back() << std::endl;
...
bool iteratorTest()
{
    ...
    for (int i = 0; i < MAX_N; i++)
    {
        ...
        myIter[0] += offset;
        myIter[1] -= offset;
        // std::cerr << *ansIter[0] << " " << *ansIter[1] << " " << *myIter[0] << " " << *myIter[1] << std::endl;
...
bool copyAndClearTest()
{
    // you should call the constructor and deconstructor correctly
    {
        ...
        for (int i = 0; i < MAX_N; i++)
        {
            ...
            // std::cerr << ansCounter << " " << myCounter << std::endl;
        }
        // std::cerr << ansCounter << " " << myCounter << std::endl;
